...
$external_docs = @{
    ...
    "uno.extensions"     = @{ ref="0960026b522c66a1617567d0d17d35788a3af431" }  #latest main commit
    ...
    "hd-docs"            = @{ ref="f0d12c19e0158a27508ce926fec2ccd2caadde6f"; dest="studio/Hot Design" } #latest main commit
}

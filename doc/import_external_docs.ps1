...
$external_docs = @{
    ...
    "uno.wasm.bootstrap" = @{ ref="2c8dd28f9635aa6fb337ba57da347f5733984432" }  #latest main commit
    ...
    "uno.samples"        = @{ ref="c11c242e729109f66e3d8907a41543909e3cdaa1" }  #latest master commit

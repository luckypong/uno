...
$external_docs = @{
    ...
    "uno.check"          = @{ ref="2cc56fed875baa20cb27a110f275008d56c36630" }  #latest main commit
    ...
    "uno.extensions"     = @{ ref="adfd4c5d93b1d507b923b69b540ac4c004d9c22b" }  #latest main commit

...
$external_docs = @{
    ...
    "uno.themes"         = @{ ref="93685993124527877b52d834db16057f666ec10c" }  #latest master commit
    "uno.toolkit.ui"     = @{ ref="9d35fdcf35289b0a03670a42a08c6aa43419f87c" }  #latest main commit

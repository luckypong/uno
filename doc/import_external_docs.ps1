...
$external_docs = @{
    ...
    "uno.themes"         = @{ ref="bbad5768b7ead97aadf2099ce12af66f058aebdf" }  #latest master commit
    ...
    "uno.extensions"     = @{ ref="691ff1d9f37ba9c789fe53557fb986d089cfcf47" }  #latest main commit

...
$external_docs = @{
    ...
    "uno.toolkit.ui"     = @{ ref="cab35f0b4712421d0de6b2ec1db5ea8fd762e490" }  #latest main commit
    "uno.check"          = @{ ref="1346eddaf78284a322b316c9fbc8774a2efbade6" }  #latest main commit
